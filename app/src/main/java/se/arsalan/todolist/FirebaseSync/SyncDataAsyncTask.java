package se.arsalan.todolist.FirebaseSync;
...
public class SyncDataAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    private se.arsalan.todolist.Todolist.Todolist Todolist;
    ...
    public SyncDataAsyncTask(se.arsalan.todolist.Todolist.Todolist todolist,
